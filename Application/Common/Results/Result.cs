...
public record Result(bool Success, ErrorTypes? ErrorType = null, string? ErrorMessage = null)
{
    ...
    public static Result Error(string message = "An unexpected error occured.") => new(false, ErrorTypes.Error, message);
...
public record Result<T>(bool Success, T? Value = default, ErrorTypes? ErrorType = null, string? ErrorMessage = null)
{
    ...
    public static Result<T> Error(string message = "An unexpected error occured.") => new(false, default, ErrorTypes.Error, message);
